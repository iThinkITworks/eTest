 ...
 * the License.
 */
package com.etest.valo;

import com.etest.main.MainUI;
...
public class Tables extends VerticalLayout implements View {
    ...
    final Container hierarchicalContainer = MainUI.generateContainer(200,
            true);
    ...
    static void configure(Table table, boolean footer, boolean sized,
        ...
        if (footer) {
            ...
            table.setColumnFooter(MainUI.DESCRIPTION_PROPERTY,
                    "description");
        ...
        table.setColumnExpandRatio(MainUI.CAPTION_PROPERTY,
                expandRatios ? 1.0f : 0);
        table.setColumnExpandRatio(MainUI.DESCRIPTION_PROPERTY,
                expandRatios ? 1.0f : 0);
