...
public class CellItemWindow extends Window {
    ...
    public CellItemWindow(int cellCaseId) {
    ...
    FormLayout buildForms(){
        ...
        create.addClickListener(createBtnClickListener);
...
//            edit.addClickListener(modifyBtnClickListener);
    ...
    Button.ClickListener createBtnClickListener = (Button.ClickEvent event) -> {
        Window sub = new ModifyCellItemWindow(getCellCaseId());
